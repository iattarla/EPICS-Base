...
epicsShareExtern void (*pvar_func_testManagerRegister)(void);
epicsShareExtern void (*pvar_func_testManagerDriverRegister)(void);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"testManager_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};

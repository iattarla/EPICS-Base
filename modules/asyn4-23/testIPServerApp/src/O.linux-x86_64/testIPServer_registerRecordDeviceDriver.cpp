...
epicsShareExtern void (*pvar_func_ipEchoServerRegister)(void);
epicsShareExtern void (*pvar_func_ipEchoServer2Register)(void);
epicsShareExtern void (*pvar_func_ipSNCServerRegistrar)(void);
epicsShareExtern void (*pvar_func_asynPortTestRegister)(void);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"testIPServer_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};

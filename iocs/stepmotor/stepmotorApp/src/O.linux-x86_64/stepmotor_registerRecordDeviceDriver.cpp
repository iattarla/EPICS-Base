...
/* Generated from ../O.Common/stepmotor.dbd */
...
epicsShareExtern dset *pvar_dset_integer_converter;
epicsShareExtern dset *pvar_dset_saveCoordinate;
...
static const char * const deviceSupportNames[99] = {
    "devAaiSoft",
    "devaaiStream",
    "devAaoSoft",
    "devaaoStream",
...
static const dset * const devsl[99] = {
    ...
    pvar_dset_integer_converter,
    pvar_dset_saveCoordinate,
...
int stepmotor_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/epics/iocs/stepmotor";
    ...
    registerDevices(pbase, 99, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"stepmotor_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    stepmotor_registerRecordDeviceDriver(*iocshPpdbbase);
}
